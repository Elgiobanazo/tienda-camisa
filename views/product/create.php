...
<div class="create-product-container">
    <form action="<?= base_url ?>product/save" method="POST" enctype="multipart/form-data">    
        <div class="image-container product-image-container">
            ...
            <img src="<?= base_url ?>assets/img/logo-camisa.png" alt="Image de la camisa" id="imgPreview">
        </div>
        ...
        <div class="input-box input-create-product">
            ...
            <div class="input-container">
                <input type="text" name="price" <?= isset($_SESSION['input_old']['price']) ? "value='{$_SESSION['input_old']['price']}'" : '';?> required>
                <label for="">Precio</label>
            </div>

            <div class="input-container input-large-container">
                <textarea name="description" required><?= isset($_SESSION['input_old']['description']) ? $_SESSION['input_old']['description'] : '';?></textarea>
                <label for="" id="label-description">Descripción</label>
            </div>

            <div class="input-container">
                <input type="text" name="stock" <?= isset($_SESSION['input_old']['stock']) ? "value='{$_SESSION['input_old']['stock']}'" : '';?> required>
            ...
            <button type="submit" class="green" style="margin: 5px auto 10px auto; padding: 8px 30px; font-size: 16px; border-radius: 5px"><i class="fa-solid fa-plus"></i> Agregar</button>
